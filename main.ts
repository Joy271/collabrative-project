...
function background (bool: boolean) {
    if (bool) {
...
/**
 * func. with parameters and return values
 * 
 * conditional statements (boleen)
 * 
 * user input
 * 
 * while loops
...
function Sprites () {
    ...
    mySprite2 = sprites.create(img`
        ...
        . . . . . f f . . f f . . . . . 
        `, SpriteKind.Player)
    mySprite.setPosition(31, 65)
    mySprite2.sayText("Are you ready to play?")
